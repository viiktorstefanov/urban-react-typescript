        ...
        <section id="homePage" className={styles.homePage}>
            ...
            <div className={styles.artists} id="artists">
                <div className={styles.artist}>
                    ...
                    <h3>Stella</h3>
                    <span className={styles['artist-info']}>Stella is very talented artist, who graduated from the art academy. She has over 8 years of experience in tattooing and her work is amazing.</span>
                </div>
                <div className={styles.artist}>
                ...
                <div className={styles.artist}>
                    ...
                    <h3>Eva</h3>
                    <span className={styles['artist-info']}>Eva has 9 years of tattoo experience and provides not only quality tattoos, but also personal approach to each client. She also specializes in temporary tattoos with natural and safe pigments.</span>
                </div>
            </div>
        </section>
    );
